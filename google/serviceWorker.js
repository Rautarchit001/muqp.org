...
self.addEventListener('push', (event) => {
  ...
  var title = 'Onion Search Engine - Privacy';
  var body = {
    'body': 'click to return to application',
    'tag': 'demo',
    'icon': 'https://1.bp.blogspot.com/-LRYeWOfzzIg/YBF7x4xHRFI/AAAAAAAAB3k/9F6p5fpbW5oBKTKyzgiXT6rErLYjA3nMwCLcBGAsYHQ/s320/google.svg.png',
    'badge': 'https://1.bp.blogspot.com/-LRYeWOfzzIg/YBF7x4xHRFI/AAAAAAAAB3k/9F6p5fpbW5oBKTKyzgiXT6rErLYjA3nMwCLcBGAsYHQ/s320/google.svg.png',
...
self.addEventListener('notificationclick', (event) => {
  var url = 'https://onion.search.newsradarr.com';
